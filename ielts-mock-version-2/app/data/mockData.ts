import { Tenant, Student, TestResult, SeatReservation, TestSection, ScheduledTest, TestSubmission } from '../types';
  ...
  questions: [
    {
      ...
      options: ['Pierre Michaux', 'Baron Karl von Drais', 'Pierre Lallement', 'John Boyd Dunlop'],
    ...
    },
    {
      ...
      options: ['The running machine', 'The bone shaker', 'The penny-farthing', 'The safety bicycle'],
    ...
    },
    {
      id: 'q5',
      type: 'fill-blank',
      question: 'Susan B. Anthony stated that the bicycle had done more to emancipate _____ than anything else.',
      correctAnswer: 'women'
    },
    {
      id: 'q6',
      type: 'multiple-choice',
      question: 'Which innovation made cycling comfortable and accessible to the masses?',
      options: ['The velocipede', 'Pneumatic tires', 'The penny-farthing', 'The Laufmaschine'],
  ...
  questions: [
    {
      ...
      options: ['University accommodation', 'Course registration', 'Library services', 'Student visa'],
  ...
  questions: [
    {
      id: 'w1',
      type: 'text',
      question: 'Task 1: The chart below shows the number of students enrolled in different courses at a university. Summarize the information by selecting and reporting the main features. Write at least 150 words.',
      correctAnswer: '' // Essay question
    },
    {
      id: 'w2',
      type: 'text',
      question: 'Task 2: Some people believe that technology has made our lives more complex. Others think it has made life easier. Discuss both views and give your opinion. Write at least 250 words.',
      correctAnswer: '' // Essay question
    }
  ]
};
...
export const mockScheduledTests: ScheduledTest[] = [
  {
    ...
    testDate: '2026-01-10',
    students: [
      { id: 'student-1', name: 'Alice Johnson', email: 'alice.johnson@email.com', accessCode: 'IELTS-2026-010', assignedSeat: 1 },
      { id: 'student-2', name: 'Bob Smith', email: 'bob.smith@email.com', accessCode: 'IELTS-2026-011', assignedSeat: 2 },
    ],
    attemptsAllocated: 2,
    status: 'scheduled'
  },
  {
    ...
    testDate: '2026-01-15',
    students: [
      { id: 'student-3', name: 'Carol White', email: 'carol.white@email.com', accessCode: 'IELTS-2026-015' },
      { id: 'student-4', name: 'David Brown', email: 'david.brown@email.com', accessCode: 'IELTS-2026-016' },
      { id: 'student-5', name: 'Emma Davis', email: 'emma.davis@email.com', accessCode: 'IELTS-2026-017' },
    ],
    attemptsAllocated: 3,
    status: 'scheduled'
  }
...
export const mockTestSubmissions: TestSubmission[] = [
  {
    ...
    sections: {
      listening: {
        answers: { 'l1': 'University accommodation', 'l2': '300', 'l3': 'This Friday', 'l4': 'second' },
        score: 8.0
      },
      reading: {
        answers: { 'q1': 'Baron Karl von Drais', 'q2': 'The bone shaker', 'q3': 'FALSE', 'q4': 'TRUE', 'q5': 'women', 'q6': 'Pneumatic tires', 'q7': 'NOT GIVEN', 'q8': 'equal' },
        score: 7.5
      },
      writing: {
        answers: {
  ...
  },
  {
    ...
    sections: {
      reading: {
        answers: { 'q1': 'Baron Karl von Drais', 'q2': 'The bone shaker', 'q3': 'TRUE', 'q4': 'TRUE', 'q5': 'women', 'q6': 'Pneumatic tires', 'q7': 'FALSE', 'q8': 'equal' }
      },
      writing: {
        answers: {
