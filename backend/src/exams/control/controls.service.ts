...
export class ControlsService {
  ...
  async startSession(scheduledTestId: string) {
    return await this.prismaService.$transaction(async (tx) => {
      const startedSession = await this.schedulesService.update(
        scheduledTestId,
        {
  ...
  async endSession(scheduledTestId: string) {
    return await this.prismaService.$transaction(async (tx) => {
      const endedSession = await this.schedulesService.update(
        scheduledTestId,
        {
  ...
  async startSection(scheduledTestId: string, section: TestSection) {
    return await this.prismaService.$transaction(async (tx) => {
      ...
      await this.schedulesService.get(scheduledTestId, tx);
