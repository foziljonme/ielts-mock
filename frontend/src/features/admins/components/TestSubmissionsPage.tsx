...
import { FileText, CheckCircle2, Clock, Eye, Save, Search } from "lucide-react";
import { mockTestSubmissions } from "../../../data/mockData";
import type { TestSubmission, Tenant } from "../types";
...
export function TestSubmissionsPage({ tenant }: TestSubmissionsPageProps) {
  ...
  const handleSaveGrades = () => {
    ...
    if (
      ...
      updatedSubmission.sections.listening
    ) {
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Review and grade student test responses
            </p>
          </div>
        </div>
                    ...
                    <DialogTrigger asChild>
                      <Button
                        ...
                        onClick={() => {
                          ...
                          setScores({
                            listening:
                              submission.sections.listening?.score || 0,
                        ...
                        <TabsContent value="responses" className="space-y-6">
                          ...
                          {submission.sections.listening && (
                            <Card className="p-4">
                              <h3 className="font-semibold mb-3 flex items-center justify-between">
                                Listening Section
                                {submission.sections.listening.score !==
                                  undefined && (
                                  <Badge>
                                    Score: {submission.sections.listening.score}
                                  </Badge>
                                )}
                              </h3>
                              <div className="space-y-2">
                                {Object.entries(
                                  submission.sections.listening.answers
                                ).map(([qId, answer]) => (
                                  <div
                                    key={qId}
                          ...
                          {submission.sections.reading && (
                            <Card className="p-4">
                              <h3 className="font-semibold mb-3 flex items-center justify-between">
                                Reading Section
                                {submission.sections.reading.score !==
                                  undefined && (
                                  <Badge>
                                    Score: {submission.sections.reading.score}
                                  </Badge>
                                )}
                              </h3>
                              <div className="space-y-2">
                                {Object.entries(
                                  submission.sections.reading.answers
                                ).map(([qId, answer]) => (
                                  <div
                                    key={qId}
                                    className="p-2 bg-gray-50 rounded"
                          ...
                          {submission.sections.writing && (
                            <Card className="p-4">
                              <h3 className="font-semibold mb-3 flex items-center justify-between">
                                Writing Section
                                {submission.sections.writing.score !==
                                  undefined && (
                                  <Badge>
                                    Score: {submission.sections.writing.score}
                                  </Badge>
                                )}
                              </h3>
                              <div className="space-y-4">
                                {Object.entries(
                                  submission.sections.writing.answers
                                ).map(([qId, answer]) => (
                                  <div key={qId}>
                          ...
                          {submission.sections.speaking && (
                            <Card className="p-4">
                              <h3 className="font-semibold mb-3 flex items-center justify-between">
                                Speaking Section
                                {submission.sections.speaking.score !==
                                  undefined && (
                                  <Badge>
                                    Score: {submission.sections.speaking.score}
                                  </Badge>
                                )}
                              </h3>
                              <div className="space-y-2">
                                {Object.entries(
                                  submission.sections.speaking.answers
                                ).map(([qId, answer]) => (
                                  <div
                                    key={qId}
                                    className="p-2 bg-gray-50 rounded"
