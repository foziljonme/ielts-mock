...
import { mockReadingSection, mockListeningSection, mockWritingSection } from '../data/mockData';
...
export function SectionSelection({ onSelectSection }: SectionSelectionProps) {
  const sections = [
    {
      id: 'listening',
      name: 'Listening',
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">Choose which section of the IELTS test you would like to take</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sections.map((section) => (
            <Card 
              ...
              onClick={() => section.section && onSelectSection(section.section)}
            >
        ...
        <Card className="mt-8 p-6 bg-blue-50 border-blue-200">
          ...
          <ul className="text-sm text-gray-700 space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>Each section has a time limit. The test will auto-submit when time expires.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600">•</span>
              <span>You can highlight text and add annotations in reading passages.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600">•</span>
