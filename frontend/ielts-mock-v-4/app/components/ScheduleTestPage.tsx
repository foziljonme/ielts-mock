...
import { Calendar, Plus, Trash2, Users, Clock, CheckCircle2, AlertCircle, Play } from 'lucide-react';
...
interface ScheduleTestPageProps {
  tenant: Tenant;
  onStartTest?: (test: ScheduledTest) => void;
}

export function ScheduleTestPage({ tenant, onStartTest }: ScheduleTestPageProps) {
                ...
                <TableRow key={test.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-2">
                      ...
                      {onStartTest && test.status === 'scheduled' && (
                        <Button
                          variant="outline"
                          size="sm"
