...
export const SECTIONS: { name: TestSkill; label: string }[] = [
  { name: TestSkill.LISTENING, label: 'Listening' },
  { name: TestSkill.READING, label: 'Reading' },
  { name: TestSkill.WRITING, label: 'Writing' },
]
